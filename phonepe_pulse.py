...
st.set_page_config(
    ...
    menu_items={
        ...
        'Get Help': "https://www.linkedin.com/in/arockia-joe-snow-a-597a5a282"
    }
)
...
if selected=="Home":
    image = Image.open("/Users/joesnowafc/Downloads/phonepe_blue.png")
...
if selected == "Top Charts":
    st.image('/Users/joesnowafc/Downloads/ppey.jpeg')
...
if selected == "Visualization":
    ...
    if Type == "TRANSACTION":
        ...
        if selected == "Agg_Transaction":
            ...
            df2 = pd.read_csv('/Users/joesnowafc/Downloads/phonepe/Statenames.csv')
            df.State = df2
